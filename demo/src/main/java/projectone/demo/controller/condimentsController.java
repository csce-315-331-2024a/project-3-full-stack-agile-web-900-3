...
/**
 * this controls teh condiments controller
 */
...
class condimentsController
{
    ...
    /**
     *  This is the constructor for the condiments  controller it takes in a repositoy from the sql database specifically the inventory table
     * @param repository the inventory table repository ie the values in the inventory table, and queries in the repository file
     */
    condimentsController(InventoryRepository repository)
    {
